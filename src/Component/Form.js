        ...
        <>
            <div class="container">
                ...
                <form style={{ marginBottom: '50px' }} >
                    ...
                    {editForm && <button style={{ marginRight: '20px' }} class="btn btn-primary" onClick={(e) => updateFormhandler(e, id, searchResults, updateArray)}>Saved Changes</button>}
                ...
                <Data array={[...array]} setSearchTerm={setSearchTerm} searchResults={searchResults} setArray={setArray} myImage={image} editRow={editRow} searchTerm={searchTerm} click={click} searchItem={searchItem} searchData={searchData} />
